...
branch
storeArtifacts"ht
      // td1111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111
...
storeArtifacts      // this.logWarn({context}, `Update status for unknown PR, ignored. Head sha == ${context.payload.sha}, repository == ${context.payload.repository.id}`);
  ...
  databaseURL: sizeConfbranchig.sizeDataba
        ...
        contextPath: pathParts.slice(1),s          path: size.jseUrl,
